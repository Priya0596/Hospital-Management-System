...
const Pathology = () => {
  ...
  return (
    <div >
      <h2><FaMicroscope className="hea" /> Pathology Department</h2>
      ...
      <div className="text-left">
              ...
              <div className="image-right" id="Neurology">
                <img src="https://img.freepik.com/premium-photo/picture-heart-with-human-heart-human-heart_1287512-64379.jpg" alt="Heart" width="500px" height="500px" />
              </div>
      </div>
      <div className='cont'>
